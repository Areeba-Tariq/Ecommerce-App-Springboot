...
<body class="bg-light">
	...
	<!-- Modified -->
        ...
        <!-- Add this script at the beginning of the body tag -->
        <script src="https://code.jquery.com/jquery-3.6.4.min.js"
                integrity="sha256-oP6HI/tZ1a9Y6qt0zHy5BqI5T9zjnrZ9R4cQiOQfPm8="
        ...
        <script>
            $(document).ready(function () {
                var errorMessage = "<c:if test='${not empty errorMessage}'>${errorMessage}</c:if>";
                if (errorMessage) {
        ...
        <button type="button" style="margin: 20px 0" class="btn btn-primary"
                data-toggle="modal" data-target="#exampleModalCenter">Add Category
        </button>
