			...
			<div class="row">
				<div class="col-sm-5">
					...
					<div class="form-group">
                        ...
                        <select class="form-control border border-warning" name="categoryid" required th:field="*{categoryid}">
                            <option value="" selected>Select a Category</option>
                            <c:forEach var="category" items="${categories}">
                                <option value="${category.id}" th:value="${category.id}" th:text="${category.name}"></option>
                            </c:forEach>
                        </select>
                    </div>
                    <!-- Modified -->
